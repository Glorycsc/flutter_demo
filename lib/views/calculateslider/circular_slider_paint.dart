...
class _CircularSliderState extends State<CircularSliderPaint> {
  ...
  void _calculatePaintData() {
    ...
    print("initPercent is : " + initPercent.toString() + " , and endPercent is : " + endPercent.toString());
...
//    _sweepAngle = percentageToRadians(sweep.abs());
    ...
    _endAngle = percentageToRadians(endPercent);
    _sweepAngle = percentageToRadians(sweep.abs());
    print("startAngle is : " + _startAngle.toString() + " ,and _endAngle is :" + _endAngle.toString() + " _sweepAngle is : " + _sweepAngle.toString());
